...
`;customElements.define("pd-header",class extends Z{static get properties(){return{src:{type:String}}}static get styles(){return[ue]}render(){return M`
      <header class="menu">
        <nav class="menu__nav">
...
`;customElements.define("pd-separator",class extends Z{static get styles(){return[me]}render(){return M`
      <div class="colores">
          <div></div>
          <div></div>
          <div></div>
...
`;customElements.define("pd-instagram",class extends Z{static get properties(){return{instagram:{type:String}}}static get styles(){return[ge]}render(){return M`
      <div class="instagram">
        <img
...
`;customElements.define("pd-footer",class extends Z{static get properties(){return{src:{type:String},instagram:{type:String},email:{type:String},twitter:{type:String},facebook:{type:String}}}static get styles(){return[_e]}render(){return M`
      <div class="footer">
...
`;customElements.define("pd-contacto",class extends Z{static get styles(){return[fe]}render(){return M`
      <div class="contacto">
...
`;customElements.define("pd-miembro",class extends Z{static get properties(){return{img:{type:String},img_mobil:{type:String},name:{type:String},type:{type:String},color:{type:String},instagram:{type:String}}}static get styles(){return[ye]}render(){return M`
      <div class="container">
        <picture>
...
`;customElements.define("pd-boton",class extends Z{static get properties(){return{text:{type:String},widthFull:{type:Number},secundary:{type:Number},link:{type:String}}}static get styles(){return[ve]}render(){return M`
      <style>
        :host a{
