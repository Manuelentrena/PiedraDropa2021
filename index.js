...
`;customElements.define("pd-header",class extends Z{static get properties(){return{src:{type:String}}}static get styles(){return[ge]}render(){return I`
      <header class="menu">
        <nav class="menu__nav">
...
`;customElements.define("pd-principal",class extends Z{static get properties(){return{img:{type:String},img_mobil:{type:String},title:{type:String},text_button:{type:String},sub_title:{type:String}}}static get styles(){return[_e]}render(){return I`
...
`;customElements.define("pd-disco",class extends Z{static get properties(){return{img:{type:String},nombreDisco:{type:String}}}static get styles(){return[fe]}render(){return I`
    ...
    `}}),customElements.define("pd-spotify",class extends Z{static get properties(){return{id:{type:String},mode:{type:String}}}render(){return I`
      <iframe 
...
`;customElements.define("pd-boton",class extends Z{static get properties(){return{text:{type:String},widthFull:{type:Number},secundary:{type:Number},link:{type:String}}}static get styles(){return[ve]}render(){return I`
      <style>
        :host a{
...
`;customElements.define("pd-febrero",class extends Z{static get properties(){return{title:{type:String},sub_title:{type:String}}}static get styles(){return[ye]}render(){return I`
...
`;customElements.define("pd-youtubesubscriber",class extends Z{static get properties(){return{href:{type:String},text:{type:String}}}static get styles(){return[be]}render(){return I`
...
`;customElements.define("pd-youtubevideo",class extends Z{static get properties(){return{id:{type:String}}}static get styles(){return[we]}render(){return I`
      <iframe
        class="video"
...
`;customElements.define("pd-separator",class extends Z{static get styles(){return[Se]}render(){return I`
      <div class="colores">
          <div></div>
          <div></div>
          <div></div>
...
`;customElements.define("pd-videos",class extends Z{static get properties(){return{title:{type:String},listVideos:{type:Object}}}static get styles(){return[xe]}render(){return I`
      <div class="videos" >
        <div>
          <h2>${this.title}</h2>
        </div>
...
`;customElements.define("pd-instagram",class extends Z{static get properties(){return{instagram:{type:String}}}static get styles(){return[Ee]}render(){return I`
      <div class="instagram">
        <img
...
`;customElements.define("pd-footer",class extends Z{static get properties(){return{src:{type:String},instagram:{type:String},email:{type:String},twitter:{type:String},facebook:{type:String}}}static get styles(){return[$e]}render(){return I`
      <div class="footer">
