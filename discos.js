...
`;customElements.define("pd-discos",class extends K{static get styles(){return[fe]}render(){return O`
      <div class="discos">
...
`;customElements.define("pd-disco",class extends K{static get properties(){return{img:{type:String},img_mobil:{type:String},title:{type:String},type:{type:String}}}static get styles(){return[ye]}render(){return O`
      <div class="container">
