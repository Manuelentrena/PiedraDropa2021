...
`;customElements.define("pd-header",class extends K{static get properties(){return{src:{type:String}}}static get styles(){return[pe]}render(){return M`
      <header class="menu">
        <nav class="menu__nav">
    ...
    `}_handleClickBurguer(){const e=this.shadowRoot.childNodes[2].childNodes[1];e.childNodes[5].classList.toggle("open"),e.childNodes[3].classList.toggle("openNav")}});const ue=X`
  .colores{
    display: flex;
  }
...
`;customElements.define("pd-separator",class extends K{static get styles(){return[ue]}render(){return M`
      <div class="colores">
          <div></div>
          <div></div>
          <div></div>
...
`;customElements.define("pd-instagram",class extends K{static get properties(){return{instagram:{type:String}}}static get styles(){return[me]}render(){return M`
      <div class="instagram">
...
`;customElements.define("pd-footer",class extends K{static get properties(){return{src:{type:String},instagram:{type:String},email:{type:String},twitter:{type:String},facebook:{type:String}}}static get styles(){return[ge]}render(){return M`
      <div class="footer">
...
`;customElements.define("pd-mienbros",class extends K{static get styles(){return[_e]}render(){return M`
      <div class="miembros">
        <div class="miembros-layout">
          <h1>MIEMBROS</h1>
          <div class="container">
            <pd-miembro
              img_mobil="https://res.cloudinary.com/manuelentrena/image/upload/v1611159980/PiedraDropa2021/manu-mobil_lw6eth.png"
              name="Manu Ramírez"
              type="Voz y Guitarra"
              color="yellow"
            ...
            <pd-miembro
              img_mobil="https://res.cloudinary.com/manuelentrena/image/upload/v1611159980/PiedraDropa2021/entrena-mobil_nliy5x.png"
              name="Manuel Entrena"
              type="Bajo"
              color="blue"
            ...
            <pd-miembro
              img_mobil="https://res.cloudinary.com/manuelentrena/image/upload/v1611159981/PiedraDropa2021/tony-mobil_imelah.png"
            ...
            <pd-miembro
              img_mobil="https://res.cloudinary.com/manuelentrena/image/upload/v1611159980/PiedraDropa2021/carlos-mobil_kp1olh.png"
              name="Carlos Muñoz"
              type="Guitarra"
              color="red"
...
`;customElements.define("pd-miembro",class extends K{static get properties(){return{img:{type:String},img_mobil:{type:String},name:{type:String},type:{type:String},color:{type:String},instagram:{type:String}}}static get styles(){return[fe]}render(){return M`
      <div class="container">
        <picture>
