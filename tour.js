...
`;customElements.define("pd-boton",class extends Z{static get properties(){return{text:{type:String},widthFull:{type:Number},secundary:{type:Number},link:{type:String}}}static get styles(){return[ye]}render(){return M`
      <style>
        :host a{
