...
`;customElements.define("pd-header",class extends K{static get properties(){return{src:{type:String}}}static get styles(){return[ue]}render(){return D`
      <header class="menu">
        <nav class="menu__nav">
